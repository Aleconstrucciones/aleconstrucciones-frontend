...
function HomeServices({ services }: Props) {
  return (
    <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-title">Nuestros Principales Servicios</h2>
        ...
        <div className="flex justify-center mt-10">
            <Link href={"/services"} className="inline-block button">Todos los servicios</Link>
        </div>
    </section>
  );
}
